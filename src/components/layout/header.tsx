        ...
        <div className="flex items-center justify-between h-16 px-6">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2">
            ...
            >
              ...
              />
              <span className="text-white text-xl font-bold tracking-wide">NEXA</span>
            </div>
          </div>
            ...
            <div className="flex justify-center">
              <div className="flex flex-wrap justify-center gap-4 max-w-4xl">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-white">Structuring</span>
                </Link>
                ...
                >
                  ...
                  <span className="text-sm font-medium text-white">Visuals</span>
                </Link>
                ...
                >
                  ...
                  <span className="text-sm font-medium text-white">Solutioning</span>
                </Link>
